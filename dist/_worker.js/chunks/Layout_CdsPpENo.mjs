...
import { e as createComponent, g as addAttribute, l as renderScript, r as renderTemplate, h as createAstro, n as getDefaultExportFromCjs, o as clsx, k as renderComponent, p as renderHead, q as renderSlot } from './astro/server_DG0ottg_.mjs';
/* empty css                         */
import { a as reactExports, b as requireReactDom, R as React2, c as React } from './_@astro-renderers_NASU7dtQ.mjs';
...
const $$ClientRouter = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<meta name="astro-view-transitions-enabled" content="true"><meta name="astro-view-transitions-fallback"${addAttribute(fallback, "content")}>${renderScript($$result, "/home/manish/projects/portfolio/node_modules/astro/components/ClientRouter.astro?astro&type=script&index=0&lang.ts")}`;
}, "/home/manish/projects/portfolio/node_modules/astro/components/ClientRouter.astro", void 0);
...
const Toast$2 = (props)=>{
    ...
    const remainingTime = React2.useRef(toast.duration || durationFromToaster || TOAST_LIFETIME);
    ...
    const heightIndex = React2.useMemo(()=>heights.findIndex((height)=>height.toastId === toast.id) || 0, [
        heights,
        toast.id
    ]);
    ...
    const duration = React2.useMemo(()=>toast.duration || durationFromToaster || TOAST_LIFETIME, [
        toast.duration,
        durationFromToaster
    ]);
    ...
    }, closeButton && !toast.jsx && toastType !== 'loading' ? /*#__PURE__*/ React2.createElement("button", {
    ...
    }, (_icons_close = icons == null ? void 0 : icons.close) != null ? _icons_close : CloseIcon) : null, (toastType || toast.icon || toast.promise) && toast.icon !== null && ((icons == null ? void 0 : icons[toastType]) !== null || toast.icon) ? /*#__PURE__*/ React2.createElement("div", {
        "data-icon": "",
    ...
    }, toast.promise || toast.type === 'loading' && !toast.icon ? toast.icon || getLoadingIcon() : null, toast.type !== 'loading' ? icon : null) : null, /*#__PURE__*/ React2.createElement("div", {
        "data-content": "",
    ...
    }, toast.jsx ? toast.jsx : typeof toast.title === 'function' ? toast.title() : toast.title), toast.description ? /*#__PURE__*/ React2.createElement("div", {
        "data-description": "",
    ...
    }, typeof toast.description === 'function' ? toast.description() : toast.description) : null), /*#__PURE__*/ React2.isValidElement(toast.cancel) ? toast.cancel : toast.cancel && isAction(toast.cancel) ? /*#__PURE__*/ React2.createElement("button", {
        "data-button": true,
        "data-cancel": true,
    ...
    }, toast.cancel.label) : null, /*#__PURE__*/ React2.isValidElement(toast.action) ? toast.action : toast.action && isAction(toast.action) ? /*#__PURE__*/ React2.createElement("button", {
        "data-button": true,
        "data-action": true,
...
const Toaster$2 = /*#__PURE__*/ React2.forwardRef(function Toaster(props, ref) {
    ...
    /*#__PURE__*/ React2.createElement("section", {
        ...
        return /*#__PURE__*/ React2.createElement("ol", {
            ...
            return /*#__PURE__*/ React2.createElement(Toast$2, {
                key: toast.id,
                icons: icons,
                index: index,
                toast: toast,
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en"> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width"><link rel="icon" type="image/svg+xml" href="/favicon.ico"><meta name="generator"${addAttribute(Astro2.generator, "content")}><title>${title}</title><meta name="description"${addAttribute(description, "content")}>${renderComponent($$result, "ClientRouter", $$ClientRouter, {})}${renderHead()}</head> <body> ${renderComponent($$result, "Providers", Providers, { "client:load": true, "client:component-hydration": "load", "client:component-path": "@/components/Providers", "client:component-export": "Providers" }, { "default": ($$result2) => renderTemplate` ${renderSlot($$result2, $$slots["default"])} ` })} </body></html>`;
}, "/home/manish/projects/portfolio/src/layouts/Layout.astro", void 0);

export { $$Layout as $, X, createLucideIcon as c, jsxRuntimeExports as j };
